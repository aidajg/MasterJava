...
public class CursoController {
	...
	@PutMapping(value="cursos/{codCurso}/{duracion}", produces= MediaType.APPLICATION_JSON_VALUE)
	...
	public Curso buscarPorPvp(@PathVariable("minimo") int minimo, @PathVariable("maximo") int maximo) {
